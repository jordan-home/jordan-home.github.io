...
categories:
  - 项目作品
description: 项目作品分类页面：可互动的在线工具、心理测评、阅读笔记等实验性作品，支持浏览器直接体验。
---
...
| 📚 <a href="/projects/md2pdf/" target="_blank">md2pdf 电子书工具</a> | 把 Markdown 文件夹拖入即生成 PDF 电子书，支持3套模板 |
| 🌫️ <a href="/projects/gradient-bg-generator.html" target="_blank">渐变晕染背景生成器</a> | 输入数字X，生成柔和朦胧的三原色渐变背景图 |
